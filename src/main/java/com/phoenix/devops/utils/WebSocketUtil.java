...
import com.phoenix.devops.exception.session.SessionNoFoundException;
...
public class WebSocketUtil {
     ...
     * @param message 消息
     */
    public static <T> void sendText(WebSocketSession session, String message) {
        try {
            if (session.isOpen()) {
    ...
    public static <T> void sendText(String namespace, T key, String message) throws SessionNoFoundException {
        ...
        WebSocketSession session = sessionRegistry.getSession(key);
        if (session == null) {
    ...
    public static class SessionRegistry<T> {
        ...
        private final Map<T, WebSocketSession> sessionMap = new ConcurrentHashMap<>();
         ...
         * @return session
         */
        public WebSocketSession getSession(T key) {
            return sessionMap.get(key);
        }

        public void putSession(T key, WebSocketSession session) {
        ...
        public void removeSession(String sessionId) {
            ...
            if (this.keyIsSessionId) {
                ...
                for (Map.Entry<T, WebSocketSession> entry : sessionMap.entrySet()) {
