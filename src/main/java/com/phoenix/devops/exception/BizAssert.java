...
import com.phoenix.devops.lang.RespCode;
...
public class BizAssert {
     ...
     */
    @Setter
    public static Integer defaultErrorCode = RespCode.PARAM_ERROR.getCode();
    ...
    public static void notEmpty(String str, String msg) {
        isTrue(!StrUtil.isEmpty(str), msg);
    }
    ...
    public static void notEmpty(String str, Supplier<String> supplier) {
        isTrue(!StrUtil.isEmpty(str), supplier);
    }
    ...
    public static void notEmpty(String str, CodeMessage errorEnum, Object... params) {
        isTrue(!StrUtil.isEmpty(str), errorEnum, params);
    }
    ...
    public static void notEmpty(Collection<?> collection, CodeMessage errorEnum, Object... params) {
        isTrue(CollUtil.isNotEmpty(collection), errorEnum, params);
    }
